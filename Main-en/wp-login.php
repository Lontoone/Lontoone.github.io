...
<html lang="en-US">
	...
	<title>Log In &lsaquo; Lontoone-en &#8212; WordPress</title>
		...
		<form name="loginform" id="loginform" action="./" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
					...
					<p id="nav">
								<a href="http://localhost/WordPress/wordpress/WordPress/wordpress/wordpress-en/wp-login.php?action=lostpassword">Lost your password?</a>
			</p>
					<script type="text/javascript">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Go to Lontoone-en</a>		</p>
			</div>
...
/* <![CDATA[ */
var _wpUtilSettings = {"ajax":{"url":"\/WordPress\/wordpress\/wordpress-en\/wp-admin\/admin-ajax.php"}};
/* ]]> */
</script>
